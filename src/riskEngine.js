function calculateRisk(transaction, recentTransactions = []) {
  ...
  /*
   * ============================================================
   * 4. GRADUATED SOURCE BALANCE DEPLETION
   * ============================================================
   *
   * The more of the source balance a transaction consumes,
   * the greater the risk contribution.
   *
   * 50-74%  -> +10
   * 75-89%  -> +20
   * 90%+    -> +30
  ...
  if (oldBalanceOrg > 0) {
    ...
    if (depletionRatio >= 0.9) {
      ...
      signals.push({
        ...
        score: 20,
        message:
          "Transaction consumes a large portion of the source account balance"
      });

    } else if (depletionRatio >= 0.5) {
      riskScore += 10;
      ...
      signals.push({
        ...
        score: 10,
        message:
          "Transaction consumes a significant portion of the source account balance"
      });
    }
  }
